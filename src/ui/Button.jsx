...
function Button({ children, disabled, to, type }) {
  const base = `text-sm inline-block rounded-full bg-yellow-400  font-bold uppercase tracking-wide  text-stone-800 transition-all duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring  focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed sm:px-6 ${
